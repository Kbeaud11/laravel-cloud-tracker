...
```bash
composer require laravel-cloud-tracker/laravel-cloud-tracker
```

### As a Local Package (Monorepo)
...
```json
{
    "repositories": [
        {
            "type": "path",
            "url": "./packages/laravel-cloud-tracker"
        }
    ]
}
```
...
```bash
composer require laravel-cloud-tracker/laravel-cloud-tracker:@dev
```
...
```bash
cd packages/laravel-cloud-tracker
composer install
./vendor/bin/phpunit
```
